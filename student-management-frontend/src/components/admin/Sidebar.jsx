...
const Sidebar = ({ setActiveComponent, handleLogout }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static z-50 lg:z-auto top-0 left-0 h-full lg:h-screen w-60 bg-blue-900 text-white flex flex-col justify-between p-4 shadow-lg transition-transform transform lg:transform-none ${
          isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
        } lg:translate-x-0`}
      >
        <div>
          <h2 className="text-xl font-semibold mb-6 text-center border-b border-white pb-2">
            Admin Panel
          </h2>
          <ul className="space-y-3">
            ...
            <li>
              <div
                className="flex justify-between items-center cursor-pointer hover:bg-blue-700 p-2 rounded-md transition duration-200"
